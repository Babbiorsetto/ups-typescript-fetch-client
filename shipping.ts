 ...
 * @export
 */
export type MailInnovationsLabelImageInternationalSignatureGraphicImage = string
/**
 * The format of a label image byte stream.
 * @export
...
export const DefaultApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        labelRecovery(body: LABELRECOVERYRequestWrapper, version: string, transId?: string, transactionSrc?: string, options: any = {}): FetchArgs {
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new RequiredError('body','Required parameter body was null or undefined when calling labelRecovery.');
            }
            // verify required parameter 'version' is not null or undefined
            if (version === null || version === undefined) {
                throw new RequiredError('version','Required parameter version was null or undefined when calling labelRecovery.');
            }
            const localVarPath = `/labels/{version}/recovery`
            ...
            const needsSerialization = (<any>"LABELRECOVERYRequestWrapper" !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
         ...
         * @throws {RequiredError}
         */
        shipment(body: SHIPRequestWrapper, version: string, transId?: string, transactionSrc?: string, additionaladdressvalidation?: string, options: any = {}): FetchArgs {
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new RequiredError('body','Required parameter body was null or undefined when calling shipment.');
            }
            // verify required parameter 'version' is not null or undefined
            if (version === null || version === undefined) {
                throw new RequiredError('version','Required parameter version was null or undefined when calling shipment.');
            }
            const localVarPath = `/shipments/{version}/ship`
                .replace(`{${"version"}}`, encodeURIComponent(String(version)));
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            const localVarHeaderParameter = {} as any;
            ...
            if (additionaladdressvalidation !== undefined) {
                localVarQueryParameter['additionaladdressvalidation'] = additionaladdressvalidation;
            }
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = Object.assign({}, localVarHeaderParameter, options.headers);
            const needsSerialization = (<any>"SHIPRequestWrapper" !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.body =  needsSerialization ? JSON.stringify(body || {}) : (body || "");
         ...
         * @throws {RequiredError}
         */
        voidShipment(version: string, shipmentidentificationnumber: string, transId?: string, transactionSrc?: string, trackingnumber?: string, options: any = {}): FetchArgs {
            // verify required parameter 'version' is not null or undefined
            if (version === null || version === undefined) {
                throw new RequiredError('version','Required parameter version was null or undefined when calling voidShipment.');
            }
            // verify required parameter 'shipmentidentificationnumber' is not null or undefined
            if (shipmentidentificationnumber === null || shipmentidentificationnumber === undefined) {
                throw new RequiredError('shipmentidentificationnumber','Required parameter shipmentidentificationnumber was null or undefined when calling voidShipment.');
            }
            const localVarPath = `/shipments/{version}/void/cancel/{shipmentidentificationnumber}`
                .replace(`{${"version"}}`, encodeURIComponent(String(version)))
                .replace(`{${"shipmentidentificationnumber"}}`, encodeURIComponent(String(shipmentidentificationnumber)));
            const localVarUrlObj = url.parse(localVarPath, true);
...
export const DefaultApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        labelRecovery(body: LABELRECOVERYRequestWrapper, version: string, transId?: string, transactionSrc?: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<LABELRECOVERYResponseWrapper> {
            const localVarFetchArgs = DefaultApiFetchParamCreator(configuration).labelRecovery(body, version, transId, transactionSrc, options);
         ...
         * @throws {RequiredError}
         */
        shipment(body: SHIPRequestWrapper, version: string, transId?: string, transactionSrc?: string, additionaladdressvalidation?: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<SHIPResponseWrapper> {
            const localVarFetchArgs = DefaultApiFetchParamCreator(configuration).shipment(body, version, transId, transactionSrc, additionaladdressvalidation, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        voidShipment(version: string, shipmentidentificationnumber: string, transId?: string, transactionSrc?: string, trackingnumber?: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<VOIDSHIPMENTResponseWrapper> {
            const localVarFetchArgs = DefaultApiFetchParamCreator(configuration).voidShipment(version, shipmentidentificationnumber, transId, transactionSrc, trackingnumber, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const DefaultApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        labelRecovery(body: LABELRECOVERYRequestWrapper, version: string, transId?: string, transactionSrc?: string, options?: any) {
            return DefaultApiFp(configuration).labelRecovery(body, version, transId, transactionSrc, options)(fetch, basePath);
        },
        /**
         * Shipping
         * @summary The Shipping API makes UPS shipping services available to client applications that communicate with UPS  using the Internet
         ...
         * @throws {RequiredError}
         */
        shipment(body: SHIPRequestWrapper, version: string, transId?: string, transactionSrc?: string, additionaladdressvalidation?: string, options?: any) {
            return DefaultApiFp(configuration).shipment(body, version, transId, transactionSrc, additionaladdressvalidation, options)(fetch, basePath);
        },
        /**
         * Void Shipment
         * @summary The Void Shipping API is used to cancel the previously scheduled shipment
         ...
         * @throws {RequiredError}
         */
        voidShipment(version: string, shipmentidentificationnumber: string, transId?: string, transactionSrc?: string, trackingnumber?: string, options?: any) {
            return DefaultApiFp(configuration).voidShipment(version, shipmentidentificationnumber, transId, transactionSrc, trackingnumber, options)(fetch, basePath);
        },
    };
};
...
export class DefaultApi extends BaseAPI {
     ...
     * @memberof DefaultApi
     */
    public labelRecovery(body: LABELRECOVERYRequestWrapper, version: string, transId?: string, transactionSrc?: string, options?: any) {
        return DefaultApiFp(this.configuration).labelRecovery(body, version, transId, transactionSrc, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof DefaultApi
     */
    public shipment(body: SHIPRequestWrapper, version: string, transId?: string, transactionSrc?: string, additionaladdressvalidation?: string, options?: any) {
        return DefaultApiFp(this.configuration).shipment(body, version, transId, transactionSrc, additionaladdressvalidation, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof DefaultApi
     */
    public voidShipment(version: string, shipmentidentificationnumber: string, transId?: string, transactionSrc?: string, trackingnumber?: string, options?: any) {
        return DefaultApiFp(this.configuration).voidShipment(version, shipmentidentificationnumber, transId, transactionSrc, trackingnumber, options)(this.fetch, this.basePath);
    }
