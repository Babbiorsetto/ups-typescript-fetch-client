...
export const DefaultApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        generateToken(grantType: string, xMerchantId?: string, options: any = {}): FetchArgs {
            // verify required parameter 'grantType' is not null or undefined
            if (grantType === null || grantType === undefined) {
                throw new RequiredError('grantType','Required parameter grantType was null or undefined when calling generateToken.');
            }
...
export const DefaultApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        generateToken(grantType: string, xMerchantId?: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<GenerateTokenSuccessResponse> {
            const localVarFetchArgs = DefaultApiFetchParamCreator(configuration).generateToken(grantType, xMerchantId, options);
...
export const DefaultApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        ...
        generateToken(grantType: string, xMerchantId?: string, options?: any) {
            return DefaultApiFp(configuration).generateToken(grantType, xMerchantId, options)(fetch, basePath);
        },
    };
};
...
export class DefaultApi extends BaseAPI {
     ...
     * @memberof DefaultApi
     */
    public generateToken(grantType: string, xMerchantId?: string, options?: any) {
        return DefaultApiFp(this.configuration).generateToken(grantType, xMerchantId, options)(this.fetch, this.basePath);
    }
