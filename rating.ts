...
export const DefaultApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        rate(body: RATERequestWrapper, version: string, requestoption: string, transId?: string, transactionSrc?: string, additionalinfo?: string, options: any = {}): FetchArgs {
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new RequiredError('body','Required parameter body was null or undefined when calling rate.');
            }
            // verify required parameter 'version' is not null or undefined
            if (version === null || version === undefined) {
                throw new RequiredError('version','Required parameter version was null or undefined when calling rate.');
            }
            // verify required parameter 'requestoption' is not null or undefined
            if (requestoption === null || requestoption === undefined) {
                throw new RequiredError('requestoption','Required parameter requestoption was null or undefined when calling rate.');
            }
            const localVarPath = `/rating/{version}/{requestoption}`
                .replace(`{${"version"}}`, encodeURIComponent(String(version)))
                .replace(`{${"requestoption"}}`, encodeURIComponent(String(requestoption)));
            ...
            const needsSerialization = (<any>"RATERequestWrapper" !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
...
export const DefaultApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        rate(body: RATERequestWrapper, version: string, requestoption: string, transId?: string, transactionSrc?: string, additionalinfo?: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<RATEResponseWrapper> {
            const localVarFetchArgs = DefaultApiFetchParamCreator(configuration).rate(body, version, requestoption, transId, transactionSrc, additionalinfo, options);
...
export const DefaultApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        rate(body: RATERequestWrapper, version: string, requestoption: string, transId?: string, transactionSrc?: string, additionalinfo?: string, options?: any) {
            return DefaultApiFp(configuration).rate(body, version, requestoption, transId, transactionSrc, additionalinfo, options)(fetch, basePath);
        },
    };
};
...
export class DefaultApi extends BaseAPI {
     ...
     * @memberof DefaultApi
     */
    public rate(body: RATERequestWrapper, version: string, requestoption: string, transId?: string, transactionSrc?: string, additionalinfo?: string, options?: any) {
        return DefaultApiFp(this.configuration).rate(body, version, requestoption, transId, transactionSrc, additionalinfo, options)(this.fetch, this.basePath);
    }
